...
// Variables for Ziegler-Nichols method
double Ku;  // ultimate gain
double Pu;  // ultimate period
bool inStep = false;  // flag to indicate if we are in the step response
...
void setup() {
  ...
  // Start the Ziegler-Nichols step response
  inStep = true;
  Serial.begin(9600);
}
