...
float distance,speed,deltad,v0;
...
void loop() {
  ...
  // if (distance<248)
  // {
  // go(5,0); //go how many square in what direction?
  // calculate_s(speed,v1,v2,v3,v4,deltaT1);
  // }
  // else if (distance<600)
  // {
  // go(12.07,135); //go how many square in what direction?
  // calculate_s(speed,v1,v2,v3,v4,deltaT1);
  // }
  // else if (distance<848)
  // {
  // go(17.07,-90); //go how many square in what direction?
  // calculate_s(speed,v1,v2,v3,v4,deltaT1);
  // }
  // else
  // {
  // speed = 0;
  // go(0,0); //go how many square in what direction?
  // calculate_s(0,v1,v2,v3,v4,deltaT1);
  // }
  go(0,0);
  v0=10;
  calculate_s(0,v1,v2,v3,v4,deltaT1);
...
void tinhtoan_quangduong_di(int v, float degree)//degree integer number pls
{
  ...
  vt1 = v * cos(3.14/4+x)+v0;
  vt2 = v * sin(3.14/4+x)*(-1)+v0;
  vt3 = v * cos(3.14/4+x)*(-1)+v0;
  vt4 = v * sin(3.14/4+x)+v0;
} 
...
void go(float d, float angle)
{
  ...
  deltad=dis-distance;
  if (deltad>300) {speed=200;}
  else if (deltad>250) {speed=150 + (deltad-250) * (200-150)/(300-250);}
  else if (deltad>150) {speed=100 + (deltad-150) * (150-100)/(250-150);}
  else if (deltad>50)  {speed=50  + (deltad-50) * (100-50)/(150-50);}
  else if (deltad>0)   {speed=0   + (deltad-0)   * (50-0)/(50-0);}
}
